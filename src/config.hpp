...
#ifndef __LUFTSCHLOSS_CONFIG_HPP__
#define __LUFTSCHLOSS_CONFIG_HPP__
...
#define luftwarn(x) SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 14); \
...
#endif //__LUFTSCHLOSS_CONFIG_HPP__
